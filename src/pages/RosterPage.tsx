          ...
          <div className="flex items-center gap-1.5 ml-auto rounded-lg dark:bg-[#b58126] dark:px-1.5 dark:py-1 dark:shadow-inner dark:[&_.header-icon]:drop-shadow-[0_1px_0_rgba(0,0,0,0.55)] dark:[&_.header-icon-btn]:text-white">
            ...
            <DropdownMenu>
              <Tooltip>
                ...
                <TooltipContent>Season chips</TooltipContent>
              </Tooltip>
            ...
            <Separator orientation="vertical" className="h-6 mx-1 bg-primary-foreground/15" />
      ...
      {isBootstrapping ? (
        ...
        <>
          ...
          <div className="min-w-0 flex-1 relative">
            ...
            {scheduleOpen && (
              <div className="absolute left-0 right-0 top-0 z-30 bg-background/95 backdrop-blur-sm border border-border rounded-xl shadow-2xl p-3 pr-10 max-h-[520px] overflow-hidden animate-accordion-down">
                <button
                  type="button"
